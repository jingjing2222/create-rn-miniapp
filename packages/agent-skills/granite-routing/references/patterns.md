...
강제 규칙은 `docs/engineering/frontend-policy.md`가 소유하고, 기능 축은 `miniapp-capabilities/references/feature-map.md`, 전체 카탈로그는 `miniapp-capabilities/references/full-index.md`가 담당합니다.
