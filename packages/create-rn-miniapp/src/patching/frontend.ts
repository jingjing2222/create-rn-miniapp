...
const FRONTEND_ENV_TYPES = dedentWithTrailingNewline`
...
const FRONTEND_CLOUDFLARE_ENV_TYPES = dedentWithTrailingNewline`
  interface ImportMetaEnv {
...
const FRONTEND_FIREBASE_ENV_TYPES = dedentWithTrailingNewline`
  interface ImportMetaEnv {
...
const FRONTEND_CLOUDFLARE_API_CLIENT = dedentWithTrailingNewline`
  function isSafeHttpUrl(value: string) {
    try {
      const parsed = new URL(value)
      return parsed.protocol === 'http:' || parsed.protocol === 'https:'
...
const FRONTEND_SAFE_STARTER_INDEX_PAGE = dedentWithTrailingNewline`
...
const FRONTEND_SAFE_STARTER_ABOUT_PAGE = dedentWithTrailingNewline`
  import { createRoute } from '@granite-js/react-native'
  import { Button, Txt } from '@toss/tds-react-native'
  import { StyleSheet, View } from 'react-native'
...
const FRONTEND_SAFE_NOT_FOUND_PAGE = dedentWithTrailingNewline`
...
const FRONTEND_FIREBASE_APP = dedentWithTrailingNewline`
...
const FRONTEND_FIREBASE_FIRESTORE = dedentWithTrailingNewline`
...
const FRONTEND_FIREBASE_FUNCTIONS = dedentWithTrailingNewline`
...
const FRONTEND_FIREBASE_PUBLIC_APP_STATUS = dedentWithTrailingNewline`
...
const FRONTEND_FIREBASE_STORAGE = dedentWithTrailingNewline`
